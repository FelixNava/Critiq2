    ...
    <div className={cardClass}>
      ...
      {saved && (
        <div className="mt-6 rounded-lg bg-emerald-50 px-4 py-3 text-sm ring-1 ring-emerald-200">
          ...
          <Link href="/recordings" className={`${inlineButtonClass} mt-3`}>
        ...
        <div className="mt-6">
          {isRecording ? (
            ...
            <button
              ...
              onClick={() => void start()}
              disabled={busy}
              className={saved ? secondaryButtonClass : buttonClass}
            >
        ...
        <div className="mt-6">
          ...
          {uploaded === 0 && (
            <p className="mt-2 text-sm text-slate-400">
              Saving as you go — parts appear here as they&apos;re recorded.
            </p>
          )}
        </div>
      )}
